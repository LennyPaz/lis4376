"""SS7 - Functions for Pseudo-Random Number Lists
...
def get_list_size():
    """prompts for list size with data validation, returns integer"""
...
def create_list(size):
    """creates pseudo-random number list with no duplicates"""
    my_list = []
    for my_iterator in range(size):
        while True:
            # randint() returns random integer between 1 and size, inclusive
...
def sort_list(test_list):
    """displays original and sorted number lists"""
